CREATE DATABASE  IF NOT EXISTS `fact_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fact_test`;
...
INSERT INTO `people` VALUES (1,'Александр','Грозный','Викторович',2.5,'2002-11-11','ibdpws-ewnupb-3oubve-xxi2j1j23'),(2,'Ибрагим','Вольный','Александрович',3.7,'2003-04-05','cty7g5e-yfditruxr-ttcyyrxu-rutsrdvk'),(3,'Анастасия','Белинкова','Юрьевна',5,'2003-10-10','k28f3b4-38d3h2-jfn42d-dk2j42');
...
BEGIN
	insert into people(name, surname, middle_name, average_mark, birth_date, uuid) values(
		name_i,
        surname_i,
        middle_name_i,
        average_mark_i,
...
BEGIN
    ...
    then
		select uuid, name, surname, middle_name, birth_date, average_mark from people;
	else 
...
-- Dump completed on 2023-02-14 16:21:41
